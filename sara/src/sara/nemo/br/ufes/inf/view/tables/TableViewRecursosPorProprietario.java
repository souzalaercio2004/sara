...
public class TableViewRecursosPorProprietario extends JFrame {
	 ...
	 */
	public static void showTableViewRecursosPorProprietario(JFrame frmMenuPrincipal, String acao) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TableViewRecursosPorProprietario frame = new TableViewRecursosPorProprietario(frmMenuPrincipal, acao);
	 ...
	 * Create the frame.
	 */
	public TableViewRecursosPorProprietario(JFrame frmMenuPrincipal, String acao) {
